...
const Paginator = ({
  ...
  return (
    <div className="flex items-center justify-center mx-auto my-10 ">
      <div className="mx-5 text-sm text-gray-600">
        <p>
          Page
          <span className="mx-1 font-semibold text-gray-900 text-md">
            {page}
          </span>
          to
          <span className="mx-1 font-semibold text-gray-900">{pageCount}</span>
          of
